...
\begin{center}\fbox{\parbox{0.92\textwidth}{\textbf{RETRACTION NOTICE (2026-08-30).} The empirical claims in this manuscript --- 835,000 Snapshot DAO votes, an 86.7\% error reduction, $1.3\%$ MAE, $R^2 = 0.98$, 84\% on the Linda problem, and GHZ entanglement doubling public-good approval from 40\% to 80\% --- are \textbf{not supported} by the code they cite. Several were hardcoded literals; the DAO figures came from five hand-written proposals rather than a dataset. See CORRECTIONS.md in the source repository. Do not cite these results.}}\end{center}
